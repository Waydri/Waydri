return {
    ...
    ["Super+ctrl+d"] = "debug_overlay",
    ["Super+ctrl+t"] = "terminal",
    ["Super+ctrl+f"] = "force_redraw",
    ["Super+F5"] = "ipc_status",
    ["Super+F6"] = "window_tree_dump",
    ["Super+F7"] = "fps_display_toggle",
    ["Super+F8"] = "damage_debug",
    ["Super+F9"] = "render_debug",
}
